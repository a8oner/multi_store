...
import 'package:flutter_new_project/customer_screens/customer_orders.dart';
import 'package:flutter_new_project/customer_screens/wishlist.dart';
              ...
              children: [
                ...
                CustomScrollView(
                  slivers: [
                    SliverAppBar(
                      centerTitle: true,
                      pinned: true, //scroll'da ekstra bir özellik
                      elevation: 0,
...
//Alert dialog için oluşturulan class kesilip widget'a aktarıldı
...
class RepeatedListTile extends StatelessWidget {
  ...
  final IconData icon;
  final Function()?
      onPressed; //**************************** ÇOK ÖNEMLİ ? EKLENEREK required özelliği pasif edildi */
  ...
  Widget build(BuildContext context) {
    return InkWell(
      //Inkwell Gesture özelliğindedir
      onTap: onPressed,
      child: ListTile(
        title: Text(title),
